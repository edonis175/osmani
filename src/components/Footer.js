    ...
    <footer className={"bg-gray-900 text-white"}>
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">OSMANI Taxi</h3>
            <p className={`mb-6 text-gray-400`}>
              Your reliable taxi service in KOSOVA. Available 24/7 for all your
          ...
          <div>
            ...
            <ul className={`space-y-2 text-gray-400`}>
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-yellow-500 mr-3 mt-1 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-500">
            &copy; {new Date().getFullYear()} OSMANI Taxi. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
